...
import WidgetBookingModal from "./WidgetBookingModal";
import SendIcon from "./icons/SendIcon";
import VoiceButton from "./VoiceButton";
import { GenerateContentResponse } from "@google/genai";

const WidgetChatbot: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full relative">
      <div
        ...
        className="flex-grow p-4 overflow-y-auto space-y-4 bg-gradient-to-b from-transparent to-black/5"
        style={{
          scrollbarWidth: "thin",
      ...
      >
        ...
        {isLoading && messages[messages.length - 1].role === Role.USER && (
          <div className="flex justify-start items-center space-x-3 animate-fade-in">
            ...
            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-2xl px-3 py-2 border border-white/20">
      ...
      <div className="p-4 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-sm border-t border-white/20">
        <form
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          ...
          <div className="flex-grow relative">
            <input
              ...
              className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl py-3 px-4 pr-10 text-sm text-white placeholder-white/60 focus:ring-2 focus:ring-purple-400 focus:border-transparent focus:outline-none transition-all duration-200 hover:bg-white/15"
              disabled={isLoading || !chat}
            />
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-2xl p-3 disabled:from-gray-500 disabled:to-gray-600 disabled:cursor-not-allowed hover:from-purple-600 hover:to-blue-600 transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
        ...
        <div className="flex items-center justify-center mt-3 text-xs text-white/50">
